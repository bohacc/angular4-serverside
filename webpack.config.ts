...
export var clientConfig = {
  target: 'web',
  entry: './src/client', // previous main.browser
  output: {
...
export var serverConfig = {
  target: 'node',
  entry: './src/server', //previous main.server
  output: {
    filename: 'index.js',
  ...
  externals: includeClientPackages(
    /@angularclass|@angular|angular2-|ng2-|ng-|@ng-|angular-|@ngrx|ngrx-|@angular2|ionic|@ionic|-angular2|-ng2|-ng|apollo-/
  ),
  node: {
    global: true,
    crypto: true,
